...
import { IconDashboard, IconSettings, IconGroup, IconGithub, IconPlugin, IconSun, IconFileText } from './icons'
...
const menuItems: { id: PageId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'prompts', label: 'Prompt 文件', icon: <IconFileText size={18} /> },
    ...
    return (
        <aside className="w-60 flex-shrink-0 bg-white dark:bg-[#1a1b1d] border-r border-gray-200 dark:border-gray-800 flex flex-col">
            ...
            <div className="px-5 py-6 flex items-center gap-3">
                ...
                <div>
                    <h1 className="font-bold text-sm leading-tight text-gray-900 dark:text-white">AI Chat Template</h1>
